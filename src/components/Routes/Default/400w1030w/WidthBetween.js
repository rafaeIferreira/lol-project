...
const WidthBetween = ({splashName})=>{

    return(
        <div className="general" style={{backgroundImage: `url(http://ddragon.leagueoflegends.com/cdn/img/champion/splash/${splashName}_0.jpg)`}}>
